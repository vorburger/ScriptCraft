				...
				Blockly.JavaScript['circle'] = function(block) {
					...
					Blockly.JavaScript['rectangle'] = function(block) {
						...
						Blockly.JavaScript['mountain'] = function(block) {
							  ...
							  var code = "lauro_extra.piramid(theDrone,"+value_width+"," +value_lenght+","+value_height+");";
							  return code;
							};					
...
Blockly.JavaScript['spawner'] = function(block) {
	  ...
	  var code = "Packages.net.canarymod.Canary.factory().entityFactory.newEntity(Packages.net.canarymod.api.entity.EntityType[('"+dropdown_name+"').toUpperCase()], theDrone.getLocation()).spawn();";
	  return code;
	};
	...
	Blockly.JavaScript['alternator'] = function(block) {
		  ...
		  var code = "lauro_extra.boxAlternate(theDrone,"+value_width+"," +value_lenght+","+material1+","+material2+");";
		  return code;
		};					
